...
$(function () {
    ...
    //树区的删除按钮事件
    $(".ls-treenode-delete").on('click', function (e) {
        var allselected = $("#" + $(this).attr("treetype") + "TreeArea").jstree().get_selected(true);
        var rightids = [];
        $(allselected).each(function (i) {
            rightids.push(allselected[i].id);
        });
        $.post($(this).attr('url'), { ids: rightids.join(',') }, LS.admin.myfn.AjaxSuccess);
    });
    //树区的启用按钮事件
    $(".ls-treenode-available").on('click', function (e) {
        var allselected = $("#" + $(this).attr("treetype") + "TreeArea").jstree().get_selected(true);
        var rightids = [];
        $(allselected).each(function (i) {
            rightids.push(allselected[i].id);
    ...
    //树区的禁用按钮事件
    $(".ls-treenode-unavailable").on('click', function (e) {
        var allselected = $("#" + $(this).attr("treetype") + "TreeArea").jstree().get_selected(true);
        var rightids = [];
        $(allselected).each(function (i) {
            rightids.push(allselected[i].id);
