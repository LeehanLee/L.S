...
namespace L.S.Model.DatabaseModel.Context
{
    public class LSInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<LSContext>
    {
        protected override void Seed(LSContext context)
        {
            ...
            try
            {
                SysDep root = new SysDep() { ID = "root", Name = "LSroot", AddBy = "init", AddDate = DateTime.Now, IsDel = false, IsAvailable = true, Parent = null, DepFullIDPath = "/root/", DepFullNamePath = "/LSroot/" };
                context.SysDeps.Add(root);
                context.SaveChanges();
                SysDep center = new SysDep { ID = "manage-center", Name = "平台中心", AddBy = "init", AddDate = DateTime.Now, IsDel = false, IsAvailable = true, ParentID = "root", ParentName = "LSroot", DepFullIDPath = "/root/manage-cente/", DepFullNamePath = "/LSroot/平台中心/" };
                ...
                var super = new SysRole { Name = "超级管理员", DefaultHomePath = "/admin/sysuser/", Level = 0, ID = "superadmin", ParentID = null, ParentName = null, RoleIDPath = "/superadmin/", RoleNamePath = "/超级管理员/", AddBy = "init", AddDate = DateTime.Now, IsDel = false, IsAvailable = true, };
                context.SysRoles.Add(super);
                context.SaveChanges();
                var admin = new SysRole { Name = "系统管理员", DefaultHomePath = "/admin/sysuser/", Level = 1, ID = "admin", ParentID = "superadmin", ParentName = "超级管理员", RoleIDPath = "/superadmin/admin/", RoleNamePath = "/超级管理员/系统管理员/", AddBy = "init", AddDate = DateTime.Now.AddSeconds(1), IsDel = false, IsAvailable = true, };
                context.SysRoles.Add(admin);
                context.SaveChanges();
                var normaluser = new SysRole { Name = "普通用户", DefaultHomePath = "/admin/sysuser/", Level = 2, ID = "normaluser", ParentID = "admin", ParentName = "系统管理员", RoleIDPath = "/superadmin/admin/normaluser/", RoleNamePath = "/超级管理员/系统管理员/普通用户/", AddBy = "init", AddDate = DateTime.Now.AddSeconds(2), IsDel = false, IsAvailable = true, };
                ...
                var SysManage = new SysRight { SortNo = 0, RightIDPath = "/SysManage/", ID = "SysManage", RightLevel = 0, Name = "系统管理", DisplayName = "系统管理", ParentID = null, ActionType = "View", MenuUrl = "/admin/sysuser/", AddBy = "init", AddDate = DateTime.Now, IsAvailable = true, IsDel = false };
                var InfoManage = new SysRight { SortNo = 1, RightIDPath = "/InfoManage/", ID = "InfoManage", RightLevel = 0, Name = "资讯管理", DisplayName = "资讯管理", ParentID = null, ActionType = "View", MenuUrl = "/admin/info/", AddBy = "init", AddDate = DateTime.Now, IsAvailable = true, IsDel = false };
                ...
                var rightList1 = new List<SysRight>
                {
                    ...
                    new SysRight {SortNo=6, RightIDPath= "/SysManage/CategoryManage/",RightLevel=1,ID="CategoryManage",Name="分类管理",DisplayName="分类管理",ParentID="SysManage",ActionType="View",MenuUrl="/admin/category/treeindex",AddBy = "init", AddByName = "init",AddDate=DateTime.Now,IsAvailable=true,IsDel=false},
                ...
                {
                    new CategoryType() {ID="InfoCategoryType",SortNo=0,AddBy = "init", AddByName = "init",AddDate=DateTime.Now,IsAvailable=true,IsDel=false,Name="资讯分类" },
                    new CategoryType() {ID="ProductCategoryType",SortNo=1,AddBy = "init", AddByName = "init",AddDate=DateTime.Now,IsAvailable=true,IsDel=false,Name="产品分类" },
                };
